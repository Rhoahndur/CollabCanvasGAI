  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      window.__debugCleanup = async (canvasId = null) => {
        ...
        if (!targetCanvasId) {
          console.warn(
            '⚠️ No canvas ID provided and no canvas currently open. Please provide a canvas ID: window.__debugCleanup("canvasId")'
          );
          return 0;
        }
    ...
    <div className="app">
      <header className="app-header">
        ...
        <div className="header-right">
          ...
          <button className="btn-share" onClick={handleOpenShareModal} title="Share Canvas">
            <svg
              viewBox="0 0 24 24"
              width="18"
              height="18"
      ...
      <main className="app-main canvas-main">
        ...
        />
        <PresenceSidebar onlineUsers={onlineUsers} currentSessionId={sessionIdRef.current} />
      </main>
