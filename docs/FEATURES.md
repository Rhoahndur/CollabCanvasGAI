...
- Firebase Function support exists for SendGrid invitation records
- Invitation links use role-scoped share tokens
- Frontend email-invite controls are not currently exposed in the share modal
